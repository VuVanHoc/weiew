...
export default function Gift() {
	return (
		<div className="mx-8">
			<section
				id="gift"
				className="relative mx-auto mt-8 flex max-w-screen-2xl flex-col items-center gap-4 lg:h-[540px] lg:flex-row lg:gap-0 lg:py-[80px]"
			>
				<div className="flex-1">
					...
					<p className="text-[18px] text-[#989B9F]">
						- File tổng hợp 3000+ review, thông tin bóc phốt những
						phòng trọ nên né khi thuê trọ ở Hà Nội
						<br />- Truy cập hoàn toàn miễn phí, giúp các bạn gen Z
						có lựa chọn tốt hơn khi đi thuê phòng trọ
					</p>
