...
export default function OnSocial() {
	return (
		<section className="relative mt-8 flex flex-col items-center bg-[url('/onsocial-bg.png')] bg-cover bg-center bg-no-repeat py-[150px]">
			...
			<Image src={onsocialImg} alt="onsocial" className="w-[80%]" />
			<Image
				src={xshape}
				alt="onsocial"
